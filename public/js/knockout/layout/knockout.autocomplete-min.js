    ...
    ko.bindingHandlers.autocomplete = {
        init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if (!options.onSelectCallBack)
                options.onSelectCallBack = options.onSelect;
            options.onSelect = function(item) {
                if (allBindings.hasFocus) {
                    allBindings.hasFocus(false);
                }
                if (options.onSelectCallBack) return options.onSelectCallBack(item);
                return item.toString();
            }
            ...
            $element.on('focus', function(e) {
                if (typeof options.showOnFocus == 'undefined' ? true : options.showOnFocus) {
                    menuShown(true);
                }
            });
            ...
            function positionMenu() {
                ...
                var dropdownWidth = elementWidth;
